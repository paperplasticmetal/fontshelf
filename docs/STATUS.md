...
Current source: **0.13.0, build 20**. Updated 2026-09-15.
...
| Xcode Release build, 0.13.0 | Passed |
...
| Google preview UI, 0.13.0 | Installed and remotely loaded samples verified |
...
Manual checks do not certify every font/script or failure case. Offline preview failure, denied folder access after relocation/revocation, broader accessibility testing and clean second-device testing remain on the release checklist. The current archive does not include the later 0.13.0 preview feature; rebuild before any submission.
